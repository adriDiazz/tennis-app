...
const Navbar = () => {
    ...
    return (
        <nav className="bg-slate-800  px-2 sm:px-4 py-2.5 ">
            ...
            <button type="button" className="text-white bg-green-600 hover:bg-green-400 focus:ring-4 focus:outline-none  font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 " 
                ...
                <div className="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-4">
                    ...
                    <li>
                        <NavLink to='/' className='block py-2 pr-4 pl-3 text-white bg-green-500 rounded md:bg-transparent md:text-gray-300 md:p-0 '>Ranking</NavLink>
                    </li>
                    </ul>
                </div>
            </div>
